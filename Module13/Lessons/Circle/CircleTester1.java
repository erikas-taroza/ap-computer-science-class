package Module13.Lessons.Circle;
...
public class CircleTester1 {
    public static void main(String[] args) {
        ...
        System.out.println(" radius is " + one.getRadius() + " and " + one.getCenter());
        System.out.println();

        // Cylinder
        System.out.println("For Cylinder two: ");
        System.out.println(
                " radius is " + two.getRadius() + ", " + two.getCenter() + ", and height is " + two.getHeight());
        System.out.println();

        // Oval
        System.out.println("For Oval three: ");
        System.out.println(" radius 1 is " + three.getRadius() + ", radius 2 is " + three.getRadius2() + ", and "
                + three.getCenter());
        System.out.println();

        // Oval Cylinder
        System.out.println("For OvalCylinder four: ");
        System.out.println(" radius 1 is " + four.getRadius() + ", radius 2 is " + four.getRadius2() + ", "
                + four.getCenter() + ", and height is " + four.getHeight());
        System.out.println();
    }
}

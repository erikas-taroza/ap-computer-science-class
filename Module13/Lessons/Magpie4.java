package Module13.Lessons;

/**
 * A program to carry on conversations with a human user. This version: - Uses
 * advanced search for keywords - Will transform statements as well as react to
 * keywords
 * 
...
public class Magpie4 {
    ...
    private String[] randomRespones = new String[] { "Interesting, tell me more.", "Hmmm.", "Do you really think so?",
            "You don't say.", "I am wondering...", "I don't know.", };
    ...
    public String getResponse(String statement) {
        ...
        else if (findKeyword(statement, "I want to", 0) >= 0 || findKeyword(statement, "I want", 0) >= 0) {
    ...
    private String transformIWantToStatement(String statement) {
        ...
        if (position != -1 && !statement.contains("to")) {
            String restOfStatement = statement.substring(position + 6).trim();
            return "Would you really be happy if you had " + restOfStatement + "?";
        } else {
            position = findKeyword(statement, "I want to", 0);
    ...
    private String transformYouMeStatement(String statement) {
        ...
        if (positionOfI != -1) {
            String restOfStatement = statement.substring(positionOfI + 2, statement.indexOf(" ", positionOfI + 2))
                    .trim();
    ...
    private String getRandomResponse() {
        ...
        int index = (int) (r * randomRespones.length);
        return randomRespones[index];
    }

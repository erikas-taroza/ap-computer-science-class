package Module14.Assignments.Picture.classes;
/*
 * Purpose:
 * 
 * < your name >
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
  ...
  public static void main(String args[]) {
    Picture p = new Picture("Module14/Assignments/Picture/images/kitten2.jpg");
    Picture smallP = p.scale(0.25, 0.25);
    smallP.write("Module14/Assignments/Picture/images/smallKitten2.jpg");
    smallP.explore();
  }

  /*****************************************************************
   * Code below this point is instrumental for the project to work, however as an
   * APCS student you are not expected to understand or modify any parts. If you'd
   * like, consider this code black box and invisible to you. You are also
   * encouraged to explore the code may be surprised with how much you understand.
   *****************************************************************/
  // current indices
  /** row index */

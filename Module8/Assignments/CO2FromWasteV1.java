...
/**
 * @purpose run methods to calculate emissions and get variables
 *
...
public class CO2FromWasteV1 {
   ...
   {
       if(myPaper) {myReduction += (184.0 * myNumPeople);}
       
       if(myPlastic) {myReduction += 25.6 * myNumPeople;}

       if(myGlass) {myReduction += 46.6 * myNumPeople;}

       if(myCans) {myReduction += 165.8 * myNumPeople;}
   }

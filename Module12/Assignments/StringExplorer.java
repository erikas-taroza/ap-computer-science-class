...
public class StringExplorer
{
    public static void main(String[] args)
    {
        ...
        System.out.println("sample.indexOf(\"fox\", 5) = " + sample.indexOf("fox", 5));
        System.out.println("sample.substring(0, 5) = " + sample.substring(0, 5));
        System.out.println("sample.compareTo(\"The quick brown fox\") = " + sample.compareTo("The quick brown fox"));

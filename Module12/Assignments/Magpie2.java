...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if(findKeyword(statement, "where") != -1 && findKeyword(statement, "you") != -1 && findKeyword(statement, "from") != -1)
        {
            response = "I am from a nest in the tree.";
        }
        else if(findKeyword(statement, "what") != -1 && findKeyword(statement, "your") != -1 && findKeyword(statement, "name") != -1)
        {
            response = "I am a bird. I do not have a name.";
        }
        else if(findKeyword(statement, "what") != -1 && findKeyword(statement, "species") != -1 && findKeyword(statement, "bird") != -1)
        {
            response = "I am a magpie.";
        }
        else
        {
    ...
    {
        int value = findKeyword(statement, goal, 0);
        return value;
    }
